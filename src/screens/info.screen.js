...
const Info = ({route, navigation}) => {
  ...
  const vehicle = vehicles.filter(element => element.id == route.params.id)[0];
  if (!vehicle) {
    return null;
  }

  const isFavorite = favorites.includes(vehicle);
      ...
      <View style={styles.container}>
        ...
        <View style={styles.actionBar}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              isFavorite ? removeFavorites(vehicle) : addToFavorites(vehicle);
            }}>
